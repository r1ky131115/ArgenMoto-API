...
namespace ArgenMoto.API.Controllers
{
    ...
    public class ArticulosController : ControllerBase
    {
        ...
        public async Task<ActionResult<ArticuloCreateDTO>> CreateArticulo(ArticuloCreateDTO articuloDto)
        {
            ...
            return CreatedAtAction(nameof(GetArticulo), new { id = articulo.IdArticulo }, _mapper.Map<ArticuloCreateDTO>(articulo));
        }
        ...
        public async Task<IActionResult> DeleteArticulo(int id)
        {
            ...
            await _articuloRepository.DeleteAsync(articulo.IdArticulo);
            return Ok();
        }
    }
}